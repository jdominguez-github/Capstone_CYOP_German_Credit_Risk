...
Logistic regression is a very common algorithm used for binary classification problems although it can be applied in many other cases. 
...
fit_rf <- train(Risk ~ .
                ...
                tuneGrid = data.frame(mtry = seq(1,15)),ntree=1000)
```
